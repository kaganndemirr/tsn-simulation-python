        ...
        for application in bag.application_list:
            if isinstance(application, NonTTApplication):
                ...
                for target in application.target_list:
                    ...
                    if bag.path_finding_method == constants.YEN:
                        yen_k_shortest_paths_as_string_list = yen_k_shortest_paths(g, application.source.name, target.name, bag.k, weight='weight')
